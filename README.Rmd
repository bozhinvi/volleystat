...
This packages contains detailed statistics on volleyball matches on team and player level for the seasons 2013/14 
to 2017/2018 in Germany. It provides the following data tables.
...
- `matchstats` contains information on mathc-player level for home and away teams
